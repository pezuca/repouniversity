...
<head>
	...
	<script src="/repouniversity/resources/js/application/admin-panel/verMateriasAdmin.js"></script>
</head>
	              ...
	              <div class="ibox float-e-margins">
	                  <div class="ibox-title">
		                  ...
		                  <div class="ibox-tools" id="agregarMateriaButton">
	                          <a href="#agregarMateriaDialog" class="btn btn-primary btn-xs"><i class="fa fa-magic"></i>  Materia</a>
	                      </div>
	                  </div>
						...
						<tbody>
							<c:forEach items="${materias}" var="materia"
								...
								<tr>
									...
									<td>
										<a href="#" name="editMateria" data-userId="${materia.id}"><button class="btn btn-primary btn-circle" type="button"><i class="fa fa-pencil"></i></button></a>
										<a href="#" name="deleteMateria" data-userId="${materia.id}" ><button class="btn btn-danger btn-circle" type="button"><i class="fa fa-times"></i></button></a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
	...
	<div id="agregarMateriaDialog" title="Nueva Materia">
		<form id="nuevoMateriaForm" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                	<select class="form-control m-b" name="carrera" required="required">
						<c:forEach items="${carreras}" var="carrera" varStatus="status">
