	 	...
	 	<div class="wrapper wrapper-content animated fadeInRight">
			<form method="post" class="form-horizontal" action="/repouniversity/seguridad/editarSeguridadPass" role="form">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10"><input value = "${seguridad.mayusculas}" name="mayusculas" type="number" min = 0 max = 100 class="form-control" required="required"></div>
	            </div>
	           	<div class="form-group">
	                <label class="col-sm-2 control-label">Cantidad Minusculas:</label>
	                <div class="col-sm-10"><input value = "${seguridad.minusculas}" name="minusculas" type="number" min = 0 max = 100 class="form-control" required="required"></div>
	            </div>
	           	<div class="form-group">
	                <label class="col-sm-2 control-label">Cantidad Especiales:</label>
	                <div class="col-sm-10"><input value = "${seguridad.especiales}" name="especiales" type="number" min = 0 max = 100 class="form-control" required="required"></div>
	            </div>
	           	<div class="form-group">
	                <label class="col-sm-2 control-label">Cantidad Numeros:</label>
	                <div class="col-sm-10"><input value = "${seguridad.numeros}" name="numeros" type="number" min = 0 max = 100 class="form-control" required="required"></div>
	            </div>
	           	<div class="form-group">
	                <label class="col-sm-2 control-label">Longitud minima:</label>
	                <div class="col-sm-10"><input value = "${seguridad.longMinima}" name="longMinima" type="number" min = 0 max = 100 class="form-control" required="required"></div>
	            </div>
	            <div class="form-group">
